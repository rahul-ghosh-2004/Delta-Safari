...
//                 type="text"
//                 readOnly
//                 value="www.DeltaSafari.com/referral/YKMefBl"
...
//               *<a href="#" className="underline">T&C</a> apply
//             </p>
//           </div>
...
//               <source src="/referal-main-page.webm" type="video/webm" />
...
//             <img src={giftImg} alt="Gift Rewards" className="w-[250px] md:w-[320px]" />
//           </div>
//         </div>
...
//               Spread the Link, Share the Rewards in just 3 steps
//             </p>

//             <div className="flex justify-center">
//               <video autoPlay muted loop playsInline className="w-full max-w-6xl rounded-xl">
//                 <source src="/rp_animation_desktop.webm" type="video/webm" />
//                 Your browser does not support the video tag.
//               </video>
//             </div>
//           </div>
...
//             <Card amount="₹200" label="On Refer" bg="cyan-100" />
//             <Card amount="₹2000" label="On Booking with Referral code" bg="purple-100" />
//             <Card amount="₹5000" label="If ₹500 withdrawal as Cash" bg="orange-100" />
//             <Card amount="₹500" label="Discount on Tour Points" bg="pink-100" />
//           </div>
...
//             {activeTab === 'terms' ? (
//               <>
//                 <Accordion title="Who can I refer?" content="You can refer anyone – friends, family, contacts, networks or anyone you think will be interested in investing in Bonds." />
//                 <Accordion title="How can I refer someone?" content="Log in to your DeltaSafari account, generate your unique referral link from your dashboard and share it with your contacts." />
//                 <Accordion title="When am I eligible to earn the referral rewards?" content="You’re eligible once the referred person completes their first transaction, and your own KYC is complete." />
//                 <Accordion title="Is there a limit on the number of people I can refer?" content="No limit. Refer as many as you want to earn uncapped rewards." />
//                 <Accordion title="What is the duration of the current referral program?" content="Valid until 31st March 2026. Only transactions during this period are eligible." />
//                 <Accordion title="Can the referee earn more rewards on subsequent transactions?" content="No, only the first transaction is eligible for rewards." />
//               </>
//             ) : (
//               <>
//                 <Accordion title="Is there a time limit till when the referral award can be claimed?" content="Yes, referee must complete their first trade within 30 days of opening their account." />
//                 <Accordion title="Can I exchange my rewards for cash?" content="Rewards cannot be exchanged for cash or any other alternative." />
//                 <Accordion title="How can I track my referrals?" content="Track referral status from your dashboard on DeltaSafari profile." />
//                 <Accordion title="How can I claim the reward? How long will it take to process?" content="Rewards are sent as vouchers by the 10th of each month for previous month’s earnings. TDS of 10% applies." />
//                 <Accordion title="Can I claim rewards for past investments?" content="Only investments made within the active referral program duration (and within 30 days) are eligible." />
//                 <Accordion title="What if I don’t receive my rewards?" content="Contact support at 080-6919 9888 or email contactus@DeltaSafari.com with your details." />
//               </>
//             )}
//           </div>
