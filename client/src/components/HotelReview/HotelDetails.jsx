                    ...
                    <div className="w-full lg:w-[65%] space-y-4">
                        <div className="grid grid-cols-3 bg-[#e7f3ff] p-4 rounded border text-sm">
                            <div>
                                ...
                                <p className="font-semibold">17 Jun 2025</p>
                            </div>
                            <div>
                        ...
                        <div className="border rounded p-4 text-sm space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-gray-700">
                                    Free cancellation (Rs.0) before <strong>16-Jun-2025</strong><br />
                                    100% Deduction From: <strong>16-Jun-2025</strong> till check-in
                                </p>
                            </div>
                            <hr className="border-gray-200" />
                            <div className="w-full space-y-2 mt-4">
                                <div className="text-green-600 font-semibold text-sm flex items-center gap-2">
                                    <span className="text-lg">✔</span> Free cancellation before 16-Jun-2025
                                </div>
                                <div className="w-full">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between mt-2 text-xs sm:text-sm font-medium text-gray-700">
                                        <span className="ml-[3.2rem] font-bold text-black">16 Jun 2025</span>
                                        <div className="flex items-end gap-2 ml-auto">
                                            <span className="text-orange-500 font-medium">(Non Refundable)</span>
                                            <div className="text-right">
                                                <div className="text-blue-600 font-semibold">17 Jun 2025</div>
...
//                         <div>
//                             <h2 className="text-xl font-semibold text-gray-800">
//                                 Hotel Signature Grand <span className="text-yellow-500">★★★☆☆</span>
//                             </h2>
//                             <p className="text-sm text-gray-500">
//                                 1A, Sub District Center, Hari Enclave, Hari Nagar, New Delhi, Delhi, 110064
//                             </p>
//                         </div>
//                         <a href="#" className="text-sm text-blue-600">[Change Hotel]</a>
//                     </div>
...
//                         <div className="w-full lg:w-[35%]">
//                             <img
//                                 src="https://img.easemytrip.com/emthotel-519654/8/m/l/446930_0.jpg"
//                                 alt="Hotel"
//                                 className="rounded-md w-full object-cover h-[220px]"
//                             />
//                         </div>
...
//                     </div>
//                     <div className="px-5 pt-3 pb-6 space-y-6 bg-white">
//                         <div className="grid grid-cols-1 md:grid-cols-[auto_auto_1fr_1fr_1fr] gap-x-4 gap-y-4 items-start">
//                             <div className="flex flex-col items-center">
//                                 <div className="border-l border-dashed border-gray-300 h-2" />
//                                 <div className="w-16 h-16 rounded-full border border-gray-300 flex items-center justify-center text-sm">
//                                     Room 1
...
//             < div className="px-5 pb-6" >
//                 <Card className="rounded-xl border shadow-sm overflow-hidden p-0">
//                     <div className="bg-gradient-to-r from-[#d0e8ff] to-[#fcb4c3] px-4 py-2 flex items-center gap-2">
//                         <h3 className="font-semibold text-sm">Payment Options</h3>
//                         <span className="text-xs text-red-600 bg-red-100 px-2 py-0.5 rounded-full font-medium">NEW</span>
//                     </div>
//                     <div className="bg-white p-4 space-y-4 text-sm">
//                         {[{ label: "Book with ₹0 Payment", value: "zero", amount: "₹0" }, { label: "Pay Full Amount Now", value: "full", amount: "₹2,800" }].map(opt => (
//                             <label
//                                 key={opt.value}
//                                 onClick={() => setSelectedPayment(opt.value)}
//                                 className={`rounded-md flex items-start p-4 cursor-pointer border-2 transition-all duration-200 ${selectedPayment === opt.value
//                                     ? "border-blue-500 bg-gradient-to-r from-[#d0e8ff] to-[#fcb4c3] shadow-sm"
//                                     : "border-gray-300 bg-[#f5f5f5]"
//                                     }`}
//                             >
//                                 <input
...
//                                         <>
//                                             <p className="text-gray-700 mt-1 text-sm">
//                                                 Pay <span className="font-semibold text-black">₹2,800</span> before <span className="font-semibold text-black">15-Jun-2025 12PM</span> to avoid auto-cancellation.
//                                             </p>
//                                             <p className="text-xs text-gray-500 mt-1">Note: Bank coupons are not applicable.</p>
//                                         </>
//                                     )}
//                                 </div>
//                             </label>
//                         ))}
//                         <div className="text-blue-600 text-sm cursor-pointer select-none">(+)&nbsp;GST Details <span className="text-gray-400 italic">(Optional)</span></div>
//                     </div>
//                 </Card>
//             </div >
//             < div className="px-5 py-4 text-sm text-gray-700 space-y-4 bg-white" >
//                 <div className="flex items-start gap-2">
...
//                     </p>
//                 </div>
//                 <Button className="w-full bg-[#f26522] hover:bg-[#e55d1c] text-white text-base py-3 rounded-full">
//                     {selectedPayment === "zero" ? "Book with ₹0" : "Continue Booking"}
//                 </Button>
//             </div >
//         </Card >
