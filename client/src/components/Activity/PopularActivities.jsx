  ...
  const handleBookNow = (activity) => {
    ...
    return (
        <div className="px-4 py-8 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 border-t border-gray-300 pt-6">
                <div>
                    <h2 className="text-xl font-semibold mb-4">Handpicked Domestic Activities</h2>
                    {activities.domestic.map((item, index) => (
                        <div
                            key={index}
                            className="relative flex bg-blue-50 border border-blue-300 rounded-xl mb-4 p-3 gap-3"
                        >
                            <img
                                src={item.image}
                                alt={item.title}
                            ...
                            <button className="absolute bottom-3 right-3 text-blue-600 text-sm font-medium flex items-center" onClick={() => handleBookNow(item)}>
                ...
                <div className="border-l border-gray-300 pl-0 md:pl-6">
