...
const categories = [
    ...
    { label: "Ayurveda", img: "https://images.emtcontent.com/holiday-img/home-img/ayurveda-holsm.png" },
    ...
    return (
        ...
        >
            ...
            <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 z-20 w-full px-4">
                <div className="overflow-x-auto max-w-[64%] mx-auto bg-white py-2 px-4 rounded-full shadow-md border border-blue-300 flex items-center gap-4 whitespace-nowrap scroll-smooth no-scrollbar">
