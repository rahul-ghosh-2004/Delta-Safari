...
// import giftImg from "/Gift and tic.png"; // adjust the path as needed

// export default function GiftRewards() {
//   return (
//     <div className="bg-[#892CDC] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row justify-between items-center text-white">
//       {/* Left content */}
...
//           Refer, Earn and Watch Your rewards Multiply! Start earning rewards
//           from Rs. 1000. The more you refer the MORE you get!
//         </p>
...
//           Please email{" "}
//           <a
//             href="mailto:contactus@indiabonds.com"
...
import React from "react";
import giftImg from "/Gift and tic.png"; // Adjust the path if needed

export default function GiftRewards() {
  // 🔹 Dynamic content stored as a JS object
  const content = {
    ...
    contactEmail: "contactus@indiabonds.com",
    imageSrc: giftImg,
    bgColor: "#892CDC", // Optional: Make background dynamic
  };
